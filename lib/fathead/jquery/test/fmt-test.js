...
describe('fmt', () => {
  ...
  describe('.splitSubwords()', () => {
    ...
    it('replaces “global-jquery-object” with “global jquery object”', () => {
      assert.strictEqual(
        splitSubwords('global-jquery-object'),
  ...
  describe('.capitalizeFirstLetter', () => {
     const capitalizeFirstLetter = require('../lib/fmt').capitalizeFirstLetter 
     
     it('returns a single word with the first letter in upper case', () => {         
         assert.strictEqual(
             capitalizeFirstLetter('category'),
             'Category')
     })
      
     it('returns three words with the first letter in upper case', () => {
         assert.strictEqual(
             capitalizeFirstLetter('the black cat'),
             'The Black Cat')
     })
  })
})
