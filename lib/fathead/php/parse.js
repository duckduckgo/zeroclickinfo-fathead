...
(function() {
    ...
    function buildExamples(examplesContainer, key) {
        ...
        let examples, phpcode, exampĺeDescription, content = '';
        ...
        exampĺeDescription = examples.querySelector('strong');


        // examples sub section
        content +=   '<span class="prog__sub">Examples</span>';

        if ( exampĺeDescription) {
            
            // get the first exampĺe description by "strong"?
            content +=   '<p>' + exampĺeDescription.textContent.trim() + '</p>';
        } else {
