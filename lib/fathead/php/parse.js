...
(function() {
    ...
    function main() {
		...
		return; 
           ...
           for(let indx in ignoredFileEndings) {
                if( file.endsWith(ignoredFileEndings[indx]) ) {
                        console.log( chalk.yellow("ignoring " + file) );
                        return;
                }
            }
	   ...
	   for(let indx in ignoredFileBeginings) {
                if( file.startsWith(ignoredFileBeginings[indx]) ) {
                        console.log( chalk.yellow("ignoring " + file) );
                        return;
                }
            }
	    ...
	    if (matches == null) { 
		console.log( chalk.cyan("unmatched - " + file) ); 
		return; 
	    }
	...
	console.log( chalk.red(className) + ' ' + chalk.green(key) + ' ' + fileName );
	parserAbstractFunction(key, fileName);
    }
...
//============================================================================//
    ...
    const ignoredFileBeginings = [
	'about',
	'pecl',
	'phar'
    ];

    const ignoredFileEndings = [
	'configuration.html',
	'constants.html',
	'construct.html',
	'installation.html',
