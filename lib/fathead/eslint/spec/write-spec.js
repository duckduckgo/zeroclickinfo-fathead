...
describe('"write()"', function() {
    ...
    var ruleDetails = ['# Title for rule 0.0\n## Rule Details\nDetails for rule 0.0', '# Title for rule 0.1\n## Rule Details\nDetails for rule 0.1', '# Title for rule 1.0\n## Rule Details\nDetails for rule 1.0'];
    ...
    describe('produces an output file', function() {
        ...
        it('replaces the output file, if present', function() {
            ...
            var content = fs.readFileSync(path);
            expect(content.toString()).not.toContain('this text must be deleted.\n');
