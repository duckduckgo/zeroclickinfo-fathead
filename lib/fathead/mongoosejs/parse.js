...
function getRedirects(article) {
	...
	if (article.indexOf("#") !== -1) {
		redirects.push(article.replace(/#/g, "."), article.replace(/#/g, " "), removeBrack(article.replace(/#/g, ".")), removeBrack(article.replace(/#/g, " ")));
	}
...
function getDetails($elem) {
	var article = formatDom($elem.children("h3").html()).replace(/<span>|<\/span>/g, "");
