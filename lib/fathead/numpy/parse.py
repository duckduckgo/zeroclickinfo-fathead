...
DOCS_URL = "https://docs.scipy.org/doc/numpy/reference/generated/"
PACKAGE_NAME = "numpy"
...
def get_redirects(title):
    ...
    delimiter.
    e.g. for title "numpy.chararray.capitalize" the redirects created are
    "numpy chararray capitalize" and "numpy chararray.capitalize".
