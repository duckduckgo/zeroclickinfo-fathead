...
class Data(object):
    """
    Object responsible for loading raw HTML data from SQLAlchemy docs:
    """
...
class DataParser(object):
    ...
    def __init__(self, data_object):
        ...
        for section in sections:
            ...
            for i in range(len(function_names)):
                self.function_sections.append([function_names[i]])
    ...
    def create_url(self, anchor):
        ...
        Returns:
            Full URL to function on the sqlalchemy doc

        """
        return SQLALCHEMY_TOC_BASE_URL + anchor
