...
'''
import sys
sys.path.append('./download/cppreference-doc-20151129/')
...
html_files = []
for root, dirnames, filenames in os.walk('./download/cppreference-doc-20151129/reference'):
...
link_map = build_link_map('./download/cppreference-doc-20151129/reference')
...
for page in proc_ins:
    ...
    root = e.parse('./download/cppreference-doc-20151129/reference/'+fn, parser=html.HTMLParser())
