...
function makeOutput(_ref) {
	...
	var logo = "https://www.drupal.org/files/project-images/logo%20(2).png";
	return ["._" + article + "\tA\t\t\t" + category + "\t\t\t\t\t\t" + logo + "\t" + abstract + "\t" + url + "\n", article + "\tR\t._" + article + "()\t\t\t\t\t\t\t\t\t\t\n"].join("");
}
...
function formatExample($elem) {
	//Some of the methods don't contain an example
